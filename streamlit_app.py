...
pages = {
    "Data": [
        st.Page("pages/1_data_upload.py", title="Upload & Preview", icon=":material/upload_file:"),
    ],
    "QC Analysis": [
        st.Page("pages/2_qc_overview.py", title="Global PCA", icon=":material/scatter_plot:"),
    ...
    "Advanced": [
        ...
        st.Page("pages/7_advanced_metrics.py", title="ICC & CV Metrics", icon=":material/query_stats:"),
    ],
}
